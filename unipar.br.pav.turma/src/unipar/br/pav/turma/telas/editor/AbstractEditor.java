...
//		scrolledComposite.setBackground(SWTResourceManager.getColor(SWT.COLOR_WIDGET_LIGHT_SHADOW));
	...
	/**
	 * Verifica se a exceção é uma exceção do tipo {@link DatabaseException}, e se for, pega a exceção do banco para
	 * mostrar uma mensagem mais legível
	 * @param e exceção a ser validada
	 * @return a mensagem, de uma forma mais legível
	 */
	...
	public int promptToSaveOnClose() {
		int ret = MessageHelper.openQuestionYesNoCancel("O registro foi alterado. Deseja salvar as alterações?");
